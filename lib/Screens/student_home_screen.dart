...
class StudentHomeScreen extends StatefulWidget {
  ...
  const StudentHomeScreen({super.key, required this.collegeId, required this.classId});
  ...
  Future<void> fetchNotices() async {
    try {
      final response = await http.get(
        Uri.parse("http://192.168.179.124:1000/notice/get/${widget.collegeId}/${widget.classId}"),
      );
